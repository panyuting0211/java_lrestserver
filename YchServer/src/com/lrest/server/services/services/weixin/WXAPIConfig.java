 ...
 */
package com.lrest.server.services.services.weixin;
...
public class WXAPIConfig {
    ...
    private static final Logger log = LoggerFactory.getLogger("WXAPIConfig");

    public static String AppSecret = "";
    public static String AppID = "";
    public static String MCH_ID="";
    public static String AccessToken = "";
    public static int AccessTokenExpires = 7200;


    private static String CURRENT_API = "https://api.weixin.qq.com/";
    private static String OPEN_API = "https://open.weixin.qq.com/";
    ...
    public static String WX_API = CURRENT_API;
    ...
    private static WXAPIConfig instance = new WXAPIConfig();

    public static WXAPIConfig getInsatnce() {
        return instance;
    }
    ...
    private WXAPIConfig() {
        ...
        log.info("WXAPIConfig Singleton create");

        log.debug("----WXAPIConfig Singleton create----");
        //
        ...
        try {
            resourceBoudle = new PropertyResourceBundle(
                    getClass()
                            .getClassLoader()
                            .getResourceAsStream(
                                    "config/weixin.properties"));


            this.AppID = resourceBoudle.getString("AppID");
            this.AppSecret = resourceBoudle.getString("AppSecret");
            this.AccessTokenExpires = Integer.parseInt(resourceBoudle.getString("AccessTokenExpires"));
            this.MCH_ID=resourceBoudle.getString("MCH_ID");


//			AccessTokenManager   accessTokenManager  = new AccessTokenManager();
//			Timer timer  = new Timer();
//			timer.schedule(accessTokenManager, (WXAPIConfig.AccessTokenExpires-300)*1000,(WXAPIConfig.AccessTokenExpires-300)*1000);
